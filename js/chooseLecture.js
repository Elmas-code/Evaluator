var lectureList = [
    ['Maschinenbau','Prof. Moriarty'],
    ['Sozialwissenschaft', 'Prof. Chaos'],
    ['Anorganische Chemie', 'Prof. White'],
    ['Stringtheorie', 'Prof. Sanchez'],
    ['Verteidigung gegen die dunklen Künste', 'Prof. Dumbledore'],
]
